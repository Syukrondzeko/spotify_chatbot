...
def create_partitioned_faiss_index_and_save_metadata(
    df, index_path, metadata_path, nlist=100
):
...
create_partitioned_faiss_index_and_save_metadata(
    df, FAISS_PATH, METADATA_FAISS_PATH, nlist=100
)
